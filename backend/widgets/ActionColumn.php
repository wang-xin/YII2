    ...
    protected function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="label label-primary"><i class="fa fa-search-plus"></i> ' . Yii::t('yii', 'View') . '</span>', $url, $options);
            };
        }
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="label label-warning"><i class="fa fa-pencil-square-o"></i> ' . Yii::t('yii', 'Update') . '</span>', $url, $options);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="label label-danger"><i class="fa fa-trash"></i> ' . Yii::t('yii', 'Delete') . '</span>', $url, $options);
            };
        }
    }
